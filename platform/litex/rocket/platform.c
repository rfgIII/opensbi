...
#define ROCKET_DEFAULT_HART_COUNT	4
#define ROCKET_DEFAULT_PLATFORM_FEATURES	SBI_PLATFORM_HAS_MFAULTS_DELEGATION
#define ROCKET_DEFAULT_UART_ADDR	0x12003000
#define ROCKET_DEFAULT_PLIC_ADDR	0x2000000
#define ROCKET_DEFAULT_PLIC_NUM_SOURCES	2
#define ROCKET_DEFAULT_CLINT_ADDR	0xc000000 
...
static int plic_rocket_warm_irqchip_init(int m_cntx_id, int s_cntx_id)
{
	int ret;
